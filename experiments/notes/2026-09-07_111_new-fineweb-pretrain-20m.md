...
step 4,000のFineWeb validation lossは2.808892、perplexityは16.5915、learning rateは3.6545e-6、経過時間は262.63秒だった。学習率の減衰後もvalidation lossは安定して低下している。NaN、OOM、shape errorは発生していない。

### 2026-09-07：step 5,000

step 5,000のFineWeb validation lossは2.804508、perplexityは16.5189、learning rateは2.9365e-6、経過時間は328.40秒だった。実験110の初期値から0.136810改善しており、10,000 stepの半分までNaN、OOM、shape errorなく進んでいる。

### 2026-09-07：step 6,000

step 6,000のFineWeb validation lossは2.801336、perplexityは16.4666、learning rateは2.1984e-6、経過時間は394.18秒だった。learning rateが2.2e-6まで下がってもvalidation lossは改善を続けており、実験110の初期値からの改善幅は0.139982となった。NaN、OOM、shape errorは発生していない。

### 2026-09-07：step 7,000

step 7,000のFineWeb validation lossは2.799132、perplexityは16.4304、learning rateは1.5200e-6、経過時間は459.84秒だった。step 6,500からさらに0.000938改善し、実験110の初期値からの改善幅は0.142186となった。NaN、OOM、shape errorは発生していない。

### 2026-09-07：step 8,000
