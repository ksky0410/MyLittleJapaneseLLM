...
step 4,200ではvalidation loss 5.138404、step 4,300では5.129627、step 4,400では5.124960、step 4,500では5.118013、step 4,700では5.104936、step 4,900では5.100070まで下がりました。step 4,800では5.108015へ小さく反発しましたが、その後に回復しています。step 4,900時点でもNaN、shape error、データ長エラー、メモリ不足は発生しておらず、学習は継続中です。
