...
CONDITION = "issue1-056base-rehearsal-ratio050-eos050-colab-6k"
CHECKPOINT_ROOT = PROJECT / "artifacts/checkpoints" / CONDITION
SAMPLES_ROOT = PROJECT / "artifacts/samples" / CONDITION
ARCHIVE = Path("/content/exp059-lightweight.tar.gz")
MANIFEST = Path("/content/exp059-manifest.json")
...
def main() -> None:
    ...
    if not files:
        raise FileNotFoundError("実験059の軽量成果物が見つかりません")
