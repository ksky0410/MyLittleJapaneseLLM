...
CONDITION = "issue1-both-50m-pretrain-5m-2p5k"
CHECKPOINT_ROOT = PROJECT / "artifacts/checkpoints" / CONDITION
SAMPLES_ROOT = PROJECT / "artifacts/samples" / CONDITION
ARCHIVE = Path("/content/exp075-lightweight.tar.gz")
MANIFEST = Path("/content/exp075-manifest.json")
...
def main() -> None:
    ...
    if not files:
        raise FileNotFoundError("実験075の軽量成果物が見つかりません")
