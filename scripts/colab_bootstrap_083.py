"""実験083の081基盤へのseed123・EOS loss weight 0.0 SFTをColab GPUで実行する。"""
...
BUNDLE = Path("/content/exp083_bundle_reassembled.tar.gz")
...
OUTPUT = "issue1-both-50m-sft-from-5m-two-pass-seed123-eos0-3k"
        ...
        json.dumps(
            {
                ...
                "condition": "both-50m-sft-from-5m-two-pass-rehearsal020-seed123-eos0",
