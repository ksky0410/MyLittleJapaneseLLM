"""実験065の分割bundleをColab上で連結し、SHA-256を検証する。"""
...
PARTS = tuple(Path(f"/content/exp065_bundle_part_{index:02d}") for index in range(3))
BUNDLE = Path("/content/exp065_bundle.tar.gz")
EXPECTED_BYTES = 122165022
EXPECTED_SHA256 = "b19323b378fbc718619eb5becd3c91d6b7c643163d1dad3ba52f927bf448df35"
