"""実験061の分割bundleをColab上で連結し、SHA-256を検証する。"""
...
PARTS = tuple(Path(f"/content/exp061_bundle_part_{index:02d}") for index in range(6))
BUNDLE = Path("/content/exp061_bundle.tar.gz")
EXPECTED_BYTES = 271827848
EXPECTED_SHA256 = "44d2f1cad370dd346af6f68b05a67ab2c70d75617b90bd5583b1341fa0f43e07"
