...
CONFIG = "configs/issue1-both-20m-rehearsal-ratio050-noeos-colab-3k.toml"
...
OUTPUT = "artifacts/checkpoints/issue1-both-20m-rehearsal-ratio050-noeos-colab-3k"
SAMPLES = "artifacts/samples/issue1-both-20m-rehearsal-ratio050-noeos-colab-3k"
...
def main() -> None:
    ...
    print(json.dumps({"experiment": "055", "input_hashes": hashes}, ensure_ascii=False, indent=2), flush=True)
    command = [
        sys.executable,
    ...
    print(json.dumps({"experiment": "055", "condition": "ratio050-noeos", "steps": 3000}, ensure_ascii=False), flush=True)
