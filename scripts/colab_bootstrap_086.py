...
BUNDLE = Path("/content/exp086_bundle_reassembled.tar.gz")
...
OUTPUT = "issue1-both-50m-sft-from-5m-two-pass-seed123-10k-770k-each"
...
def main() -> None:
    ...
    required = {
        CONFIG: "919d1acee3929091b399dc8863d1906b4097ee90abea57baedcf0a7990f2f726",
        ...
        json.dumps(
            {
                ...
                "condition": "both-50m-sft-770k-each-rehearsal020-seed123-10k",
