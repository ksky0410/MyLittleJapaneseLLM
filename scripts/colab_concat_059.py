"""実験059の分割bundleをColab上で連結し、SHA-256を検証する。"""
...
PARTS = tuple(Path(f"/content/exp059_bundle_part_{index:02d}") for index in range(6))
BUNDLE = Path("/content/exp059_bundle.tar.gz")
EXPECTED_BYTES = 271827474
EXPECTED_SHA256 = "d806b0258e4138b0f6cc343803570bda10fc5d3f0fc19b22ce9f383b6e8d0516"
