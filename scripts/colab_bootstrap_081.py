"""実験081の50M・5M Token二周相当の事前学習をColab GPUで実行する。"""
...
BUNDLE = Path("/content/exp081_bundle.tar.gz")
...
OUTPUT = "issue1-both-50m-pretrain-5m-5k"
        ...
        json.dumps(
            {
                ...
                "condition": "issue1-both-50m-pretrain-5m-two-pass-budget",
                "verified_inputs": len(required),
                "train_tokens": 4_999_958,
            },
            ensure_ascii=False,
        ),
        flush=True,
