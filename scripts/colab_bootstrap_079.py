"""実験079の50M基盤へのseed123・長文応答層化SFTをColab GPUで実行する。"""
...
BUNDLE = Path("/content/exp079_bundle.tar.gz")
PROJECT = Path("/content/small_llm_079")
...
OUTPUT = "issue1-both-50m-sft-from-5m-long025-seed123-3k"
        ...
        json.dumps(
            {
                ...
                "condition": "both-50m-sft-from-5m-rehearsal020-long025-seed123",
