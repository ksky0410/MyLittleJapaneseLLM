"""実験085の081基盤への10,000 step SFTをColab GPUで実行する。"""
...
BUNDLE = Path("/content/exp085_bundle_reassembled.tar.gz")
PROJECT = Path("/content/small_llm_085")
...
OUTPUT = "issue1-both-50m-sft-from-5m-two-pass-seed123-10k"
...
def main() -> None:
    ...
    required = {
        CONFIG: "649e3465dead7c722d55ded60a16855d3dccb60642e2d0ca281825ee6075f2aa",
        ...
        json.dumps(
            {
                ...
                "condition": "both-50m-sft-from-5m-two-pass-rehearsal020-seed123-10k",
