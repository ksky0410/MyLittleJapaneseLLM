"""実験078の50M基盤へのseed123・標準SFTをColab GPUで実行する。"""
...
BUNDLE = Path("/content/exp078_bundle.tar.gz")
...
OUTPUT = "issue1-both-50m-sft-from-5m-seed123-3k"
        ...
        json.dumps(
            {
                ...
                "condition": "both-50m-sft-from-5m-rehearsal020-seed123",
