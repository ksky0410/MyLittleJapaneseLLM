...
CONDITION = "issue1-056base-rehearsal-ratio050-eos075-colab-3k"
CHECKPOINT_ROOT = PROJECT / "artifacts/checkpoints" / CONDITION
SAMPLES_ROOT = PROJECT / "artifacts/samples" / CONDITION
ARCHIVE = Path("/content/exp058-lightweight.tar.gz")
MANIFEST = Path("/content/exp058-manifest.json")
...
def main() -> None:
    ...
    if not files:
        raise FileNotFoundError("実験058の軽量成果物が見つかりません")
