...
CONDITION = "issue1-both-50m-sft-source-rehearsal020-colab-3k"
CHECKPOINT_ROOT = PROJECT / "artifacts/checkpoints" / CONDITION
SAMPLES_ROOT = PROJECT / "artifacts/samples" / CONDITION
ARCHIVE = Path("/content/exp074-lightweight.tar.gz")
MANIFEST = Path("/content/exp074-manifest.json")
...
def main() -> None:
    ...
    if not files:
        raise FileNotFoundError("実験074の軽量成果物が見つかりません")
