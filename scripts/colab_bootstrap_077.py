"""実験077の50M基盤への長文応答層化SFTをColab GPUで実行する。"""
...
BUNDLE = Path("/content/exp077_bundle.tar.gz")
...
OUTPUT = "issue1-both-50m-sft-from-5m-long025-3k"
        ...
        json.dumps(
            {
                ...
                "condition": "both-50m-sft-from-5m-rehearsal020-long025",
