"""実験074の50M both-SFT rehearsal ratio 0.20をColab GPUで実行する。"""
...
PROJECT = Path("/content/small_llm_074")
CONFIG = "configs/issue1-both-50m-sft-source-rehearsal020-colab-3k.toml"
BASE = "artifacts/checkpoints/issue1-both-50m-pretrain-mps-2p5k/best.pt"
...
OUTPUT = "issue1-both-50m-sft-source-rehearsal020-colab-3k"
...
def main() -> None:
    ...
    required = {
        CONFIG: None,
        BASE: "6f555eeb7e3dbc2bab925d7f868444c40edc7f0c1dee1a54c7c03c91d61a2503",
        ...
        json.dumps(
            {
                ...
                "condition": "both-50m-sft-rehearsal-ratio020",
    ...
    print(json.dumps({"experiment": "074", "steps": 3000}, ensure_ascii=False), flush=True)
