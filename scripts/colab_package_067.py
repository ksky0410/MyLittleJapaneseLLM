...
CONDITION = "issue1-both-20m-sft-source-rehearsal020-colab-3k"
CHECKPOINT_ROOT = PROJECT / "artifacts/checkpoints" / CONDITION
SAMPLES_ROOT = PROJECT / "artifacts/samples" / CONDITION
ARCHIVE = Path("/content/exp067-lightweight.tar.gz")
MANIFEST = Path("/content/exp067-manifest.json")
...
def main() -> None:
    ...
    if not files:
        raise FileNotFoundError("実験067の軽量成果物が見つかりません")
