...
CONDITION = "issue1-056base-rehearsal-ratio050-eos050-colab-6k-fixedlr3k"
CHECKPOINT_ROOT = PROJECT / "artifacts/checkpoints" / CONDITION
SAMPLES_ROOT = PROJECT / "artifacts/samples" / CONDITION
ARCHIVE = Path("/content/exp060-lightweight.tar.gz")
MANIFEST = Path("/content/exp060-manifest.json")
...
def main() -> None:
    ...
    if not files:
        raise FileNotFoundError("実験060の軽量成果物が見つかりません")
